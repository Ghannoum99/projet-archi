...
public class MenuPrincipal extends JFrame {
    ...
    public void afficherBoutonAjouterReservation() {
        ...
        boutonAjouterReservation.addActionListener(e -> {
            MenuReservation menuReservation = new MenuReservation("Nouvelle réservation", null);
    ...
    private void actualiserTableau() {
        ArrayList<Entite> listeReservations = Controleur.getReservationRepo().stream().map(reservation ->
                new Entite(reservation.getSalle().getNom() + " - " + reservation.getPersonne().getNom() + " " + reservation.getPersonne().getPrenom() + " " + reservation.getCreneaux().stream().map(creneau -> creneau.getDebut() + " - " + creneau.getFin()).collect(Collectors.toCollection(ArrayList::new)), reservation.getIdentifiant())
    ...
    private void afficherBoutonSupprimerReservation() {
        JButton boutonSupprimerReservation = new JButton();
    ...
    private void afficherBoutonModifierReservation() {
        JButton boutonModifierReservation = new JButton();
        ...
        boutonModifierReservation.addActionListener(e -> {
            MenuReservation menuReservation = new MenuReservation("Modifier la réservation", tableauReservations.getSelectedValue().valeur());
            menuReservation.setVisible(true);
            menuReservation.addWindowListener(new WindowListener() {
                @Override
                public void windowOpened(WindowEvent e) {
